...
class modelo_usuario {
    ...
    public function __construct($id, $correo, $usuario, $clave, $nombre, $apellido, $apellido_2, $telefono, $telefono_2, $empresa, $correo_empresa, $cuenta, $estado, $creado) {
        $this -> id = $id;
        $this -> correo = $correo;
    ...
    public function get_telefono_2() { return $this -> telefono_2; }
    ...
    public function set_telefono_2($telefono_2) { $this -> telefono_2 = $telefono_2; }
